...
from module.GATLayer import PositionwiseFeedForward, WSGATLayer, SWGATLayer, WGATLayer
...
class WSWGAT(nn.Module):
    def __init__(self, in_dim, out_dim, num_heads, attn_drop_out, ffn_inner_hidden_size, ffn_drop_out, feat_embed_size, layerType):
        ...
        if layerType == "W2S":
            ...
            self.layer = MultiHeadLayer(in_dim, int(out_dim / num_heads), num_heads, attn_drop_out, feat_embed_size, layer=WGATLayer)
        else:
